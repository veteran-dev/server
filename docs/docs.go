...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "成功",
                        "schema": {
                            "$ref": "#/definitions/response.CarDetailResp"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "成功",
                        "schema": {
                            "$ref": "#/definitions/city.CityDataList"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "成功",
                        "schema": {
                            "$ref": "#/definitions/response.OrderCreateResp"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "成功",
                        "schema": {
                            "$ref": "#/definitions/response.PriceResp"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "response.CarDetailResp": {
            "type": "object",
            "properties": {
                "detail": {
                    "$ref": "#/definitions/response.CarDetail"
                },
                "fromAreaID": {
                    "description": "起点区域ID",
                    "type": "integer"
